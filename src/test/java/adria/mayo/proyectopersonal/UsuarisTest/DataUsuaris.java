...
public class DataUsuaris {
    ...
    public static List<Usuari> listaUsuari() {
        return List.of(
                new Usuari("12345678A", "prueba1", "prueba1C", "123456789", "pepe@", "1234", "pepe", Pais.ESPANYA, "04444", "prueba", "prueba", Rol.CLIENTE, EstatUsuari.ACTIVO, null, null, null, null,null),
                new Usuari("12345678A", "prueba1", "prueba1C", "123456789", "pepe@", "1234", "pepe", Pais.ESPANYA, "04444", "prueba", "prueba", Rol.CLIENTE, EstatUsuari.ACTIVO, null, null, null, null,null),
                new Usuari("12345678A", "prueba1", "prueba1C", "123456789", "pepe@", "1234", "pepe", Pais.ESPANYA, "04444", "prueba", "prueba", Rol.CLIENTE, EstatUsuari.ACTIVO, null, null, null, null,null),
                new Usuari("12345678A", "prueba1", "prueba1C", "123456789", "pepe@", "1234", "pepe", Pais.ESPANYA, "04444", "prueba", "prueba", Rol.CLIENTE, EstatUsuari.ACTIVO, null, null, null, null,null)
        );
    ...
    public static Usuari crearUsuari() {
        return new Usuari("49828550Q", "prueba1", "prueba1C", "665582953", "pepe@gmail.com",
                ...
                Rol.CLIENTE, EstatUsuari.ACTIVO, null, null, null, null,null);
    ...
    public static Usuari crearUsuariAdmin() {
        return new Usuari("49828550Q", "admin", "admin", "665582953", "admin@gmail.com",
                ...
                Rol.ADMINISTRADOR, EstatUsuari.ACTIVO, null, null, null, null,null);
    ...
    public static Usuari crearUsuariInactivo() {
        return new Usuari("12345678A", "prueba1", "prueba1C", "123456789", "pepe@",
                "1234", "pepe", Pais.ESPANYA, "04444", "prueba", "prueba",
                Rol.CLIENTE, EstatUsuari.INACTIVO, null, null, null, null,null);
